...
public class AnnoInjection {
	...
	public static Object getBean(Object obj) {
		try {
			...
			for (Field ff : f) {
				// 获得属性上的注解
				com.javaaop.annon.Seven s = ff.getAnnotation(com.javaaop.annon.Seven.class);
				if (s != null) {
			...
			for (Method mm : m) {
				// 获得方法注解
				com.javaaop.annon.Seven s = mm.getAnnotation(com.javaaop.annon.Seven.class);
				if (s != null) {
